// 생성물 — scripts/oneshot/extract-file-icons.mjs (material-icon-theme, MIT).
// 손으로 고치지 말 것. 아이콘을 더하려면 스크립트의 WANTED에 이름을 넣고 다시 돌린다.
//
// **왜 인라인인가**: 1251개 중 쓰는 것은 아래 36개뿐이고 각각 경로 한둘이라
// 통째로 담아도 작다. 패키지를 의존성에 두면 런타임에 안 쓰는 1200개가 따라온다.

export interface FileGlyph {
  viewBox: string;
  /** `fill`이 null이면 currentColor를 쓴다 — 단색 아이콘이 틴트를 받게 하기 위함이다. */
...
export const FILE_GLYPHS = {
  ...
  "toml": {
    ...
    "paths": [
      {
        "d": "M4 6V4h8v2H9v7H7V6z",
        "fill": "#cfd8dc"
      },
      {
        "d": "M4 1v1H2v12h2v1H1V1zm8 0v1h2v12h-2v1h3V1z",
        "fill": "#ef5350"
      }
    ]
  },
  ...
  "test-ts": {
    ...
    "paths": [
      ...
      {
        "d": "M19.72 20.715a1 1 0 0 0-1.134-.318 5 5 0 0 1-1.18.262 3.95 3.95 0 0 1-1.862-.292 2.74 2.74 0 0 0-3.371.489 2 2 0 0 0-.237.35L10 24h12Z",
        "fill": "#0288d1"
      }
    ]
  },
...
} as const satisfies Record<string, FileGlyph>;

export type FileGlyphName = keyof typeof FILE_GLYPHS;
